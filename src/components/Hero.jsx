...
import { Sparkles, Box, Database } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-20 px-4 z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-200 dark:bg-white/5 border border-slate-300 dark:border-white/10 backdrop-blur-md mb-8 animate-[fade-in_1s_ease-out]">
            <span className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse"></span>
            <span className="text-sm font-medium tracking-wide text-slate-700 dark:text-slate-300 uppercase">
              Available for new opportunities
            </span>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-extrabold tracking-tighter mb-6 text-slate-900 dark:text-white">
            Crafting Modern <br />
          ...
          {/* Updated Intro Text to include MIS Executive */}
          <p className="max-w-2xl text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
            Hi, I'm <span className="font-semibold text-slate-900 dark:text-white">Mohd.Sahil</span>. I am a Frontend Developer and MIS Executive. I engineer scalable web applications, automated workflows, and data-driven dashboards using the PERN stack to solve complex business challenges.
          </p>

          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <a href="#projects" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold hover:scale-105 hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.5)] transition-all duration-300 text-center">
              View My Work
            </a>
        ...
        <div className="relative flex justify-center lg:justify-end items-center mt-10 lg:mt-0 perspective-1000">
          ...
          <div className="relative w-72 h-72 sm:w-96 sm:h-96 animate-[bounce_6s_ease-in-out_infinite]">
            ...
            {/* Updated Floating Badge for MIS/Frontend context */}
            <div className="absolute -bottom-6 -left-6 sm:-left-10 px-6 py-3 bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-2xl shadow-xl flex items-center gap-3 animate-[pulse_4s_ease-in-out_infinite] z-30">
              <div className="p-2 bg-blue-100 dark:bg-blue-500/20 rounded-lg text-blue-600 dark:text-blue-400">
                <Database size={20} />
              </div>
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-white">Frontend & MIS</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">Expertise</p>
              </div>
            </div>
          </div>
        </div>
